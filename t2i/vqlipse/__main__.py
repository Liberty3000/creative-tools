import click, json, gc, os, random, pprint, time, types, yaml
...
'{"0":{"perceptor":["ViT-B/32","ViT-B/16"], "p_weights":[1.00,0.25], "cutn":64, "cutp":0.50, "steps":200, "init_weight":0.0, "lr":0.10, "image_w":256, "image_h":256},\
  "1":{"perceptor":["ViT-B/32","ViT-B/16"], "p_weights":[1.00,0.25], "cutn":64, "cutp":1.00, "steps":150, "init_weight":2.0, "lr":0.01, "image_w":512, "image_h":512}}', type=str)
